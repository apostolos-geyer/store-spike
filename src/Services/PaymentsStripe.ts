...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
            ...
            line_items: input.lines.map((line) => ({
              ...
              price_data: {
                ...
                product_data: {
                  ...
                  ...(line.preorder ? { description: "Pre-order — ships when the run is made" } : {}),
    ...
    const parseEvent = Effect.fn("PaymentsStripe.parseEvent")(function* (
      ...
      if (isCharge) {
        const charge = event.data.object as Partial<Stripe.Charge> &
          Partial<Stripe.Dispute>;
        const intent =
      ...
      return {
        ...
        shipCountry:
          object.collected_information?.shipping_details?.address?.country ?? null,
        /**
