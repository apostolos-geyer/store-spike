...
export const ProductStatus = Schema.Literals([
  "draft",
  "active",
  "unavailable",
  "archived",
...
export class PreorderRefused extends Schema.TaggedErrorClass<PreorderRefused>()(
  "PreorderRefused",
  {
 ...
 */
export class DeletionRefused extends Schema.TaggedErrorClass<DeletionRefused>()(
  "DeletionRefused",
  {
    reason: Schema.Literals([
      "expired",
