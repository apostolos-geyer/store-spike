 ...
 */
export const PRODUCT_STATUSES = ["draft", "active", "unavailable", "archived"] as const;
 ...
 */
export const VARIANT_MODES = ["stock", "preorder"] as const;
...
/**
 * The fake provider's session table, re-exported so drizzle-kit picks it up.
 * It is declared beside the fake — it stands in for state a real provider holds
 * on its own side, and it is not part of the store's domain.
 */
